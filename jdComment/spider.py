...
# # 京东爬虫
# # 初始化 ChromiumPage 并加载用户数据
# dp = ChromiumPage()

# dp.listen.start('api.m.jd.com/?appid=item-v3&functionId=pc_club_productPageComments')

# dp.get("https://item.jd.com/100149708972.html#comment")

# dp.scroll.to_bottom()

# # dp.ele('css:.ui-pager-next').click()

# # dp.ele('css:#detail > div.tab-main.large > ul > li.current')
# # 好评
# dp.ele('css:#comment > div.mc > div.J-comments-list.comments-list.ETab > div.tab-main.small > ul > li:nth-child(5) > a').click()

# dp.ele('css:#comment > div.mc > div.J-comments-list.comments-list.ETab > div.tab-main.small > ul > li.current > a').click()

# dp.scroll.to_bottom()

# for page in range(1, 21):
#     resp = dp.listen.wait(count=1)
